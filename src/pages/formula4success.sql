...
insert into GrandPrix_ConstructorStanding_Ref (position, points) values ('4', '20');
insert into GrandPrix_ConstructorStanding_Ref (position, points) values ('5', '12');
...
insert into GrandPrix_ConstructorStanding_2 (position, gpName, year) values ('4', 'Monaco Grand Prix', '2023');
insert into GrandPrix_ConstructorStanding_2 (position, gpName, year) values ('5', 'Australian Grand Prix', '2023');
...
insert into ConstructorHolds (position, gpName, year, constructorName) values ('4', 'Monaco Grand Prix', '2023', 'Red Bull Racing'); 
insert into ConstructorHolds (position, gpName, year, constructorName) values ('5', 'Australian Grand Prix', '2023', 'Aston Martin'); 
